...
<ul>
    ...
    <!-- Laravel Exercises -->
    <li class="dropdown">
        <a href="#">Laravel Exercises ▾</a>
        <div class="dropdown-content">
            <a href="{{ route('exercises.index') }}">Guzzle Exercises</a>
        </div>
    </li>
    ...
    <li class="dropdown">
        ...
        <div class="dropdown-content">
            <a href="{{ route('admin.exercises.index') }}">Manage Exercises</a>
    ...
    <main class="main-content">
        <div class="dashboard-header">
            <h1 class="page-title">  Dashboard 2</h1>
